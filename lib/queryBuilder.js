...
function createQueryBuilder() {
  ...
  function addRelation(relation) {
    ...
    if (relation.manyToMany === true) {
      joins.push('left join ' + relation.table + ' on ' + relation.table+'.'+relation.parentField + ' = ' + table+'.id');
      ...
      joins.push('left join ' + relation.resource.type.table + ' on ' + relation.resource.type.table+'.'+relation.field + ' = ' + table+'.id');
    } else {
      joins.push('left join ' + relation.resource.type.table + ' on ' + relation.resource.type.table+'.id' + ' = ' + relation.table+'.'+relation.field);
    }
  }
